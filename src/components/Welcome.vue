    ...
    <div class="welcome-block">
        <div class="welcome-block-main rel">
            <div v-show="!showBtn" class="welcome-box-center" :class="[{die:closeText}]">
                ...
                <span v-show="!loaded" class="welcome-text line7 fail" :class="[{play:showResult}]">额，会的技术比较多</span>
                <span v-show="loaded" class="welcome-text line7 success" :class="[{play:showResult}]">额，会的技术比较多</span>
                <span @animationend="textFinish" v-show="!loaded" class="welcome-text line8 fail" :class="[{play:showResult}]">iOS开发工程师优先</span>
                <span @animationend="textFinish" v-show="loaded" class="welcome-text line8 success" :class="[{play:showResult}]">iOS开发工程师优先</span>
